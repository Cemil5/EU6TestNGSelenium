...
4. Verify that page subtitle "Options" is displayed
    */
    ...
    @Test
    public void test1(){
        TestBase.extentLogger = TestBase.report.createTest("Calendar Event test");

        TestBase.extentLogger.info("Go to “https://qa1.vytrack.com/\"");
        LoginPage loginPage = new LoginPage();
        TestBase.extentLogger.info("Login as a store manager");
        loginPage.loginAsStoremanager();

        TestBase.extentLogger.info("Navigate to “Activities -> Calendar Events”");
        DashboardPage dashboardPage = new DashboardPage();
        dashboardPage.navigateToModule("Activities", "Calendar Events");

        TestBase.extentLogger.info("Verify that page subtitle \"Options\" is displayed");
...
4. Verify that page number is equals to "1"
    ...
    public void test2(){
        ...
        TestBase.extentLogger.info("Verify that page number is equals to \"1\"");
        CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
 ...
 */
    ...
    public void test3() {
        ...
        TestBase.extentLogger.info("Verify that view per page number is equals to \"25\"");
        CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
...
public void test4() {
    ...
    TestBase.extentLogger.info("Verify that number of calendar events (rows in the table) is equals to number of records");
    CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
    calendarEventsPage.waitUntilLoaderScreenDisappear();
...
public void test5() {
    ...
    TestBase.extentLogger.info("Click on the top checkbox to select all");
    CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
    calendarEventsPage.waitUntilLoaderScreenDisappear();
    calendarEventsPage.mainCheckBox.click();

    TestBase.extentLogger.info("Verify that all calendar events were selected");
...
Call Via Hangout : No
    ...
    public void test6() {
        ...
        TestBase.extentLogger.info("Select “Testers meeting”");
        CalendarEventsPage calendarEventsPage = new CalendarEventsPage();
        calendarEventsPage.waitUntilLoaderScreenDisappear();
        calendarEventsPage.testersMeeting.click();

        TestBase.extentLogger.info("Verify that following data is displayed");
